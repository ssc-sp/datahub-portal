...
namespace Datahub.Portal.Services.Offline
{
    public class OfflineMyDataService : IMyDataService
    {
        ...
        public Task UploadGen2File(FileMetaData fileMetadata, string projectUploadCode, string containerName)
        {
            return Task.CompletedTask;
        }

        public Task UploadGen2File(FileMetaData fileMetadata, string projectUploadCode, string containerName, Action<long> progress)
        {
            return Task.CompletedTask;
        }

        public Task<Folder> GetFolderStructure(Folder folder, Microsoft.Graph.User user, bool onlyFolders = true)
        {
            return Task.FromResult((Folder)null);
        }

        public Task<Folder> GetFolderContents(Folder folder, string filterSearch, Microsoft.Graph.User user)
        {
            return Task.FromResult((Folder)null);
        }
    }
