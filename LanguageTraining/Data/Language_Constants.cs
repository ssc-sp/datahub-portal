...
namespace Datahub.Portal.Data.LanguageTraining
{
    public class Language_Constants
    {
        ...
        public static readonly string[] TRAININGTYPEENGLISH = { "Group Training - Full-Time Training", "Group Training - Part-Time Training", "Individual - Coaching" };
        public static readonly string[] TRAININGTYPEFRENCH = { "Group Training - Full-Time Training", "Group Training - Part-Time Training", "Individual - Coaching", "FOURTH OPTION" };
        ...
        public static readonly string[] CLASSES_E = { "Beginner 1",
                                                    ...
                                                    "Intermediate 5 (BBB)",
                                                    "Intermediate 6 (BBB)",
                                                    "Intermediate 7 – Test Oral Proficiency – B level",
                                                    "Advanced 1 (CBC)",
                                                    "Advanced 2 (CBC)",
                                                    "Advanced 3 (CBC)",
                                                    "Advanced 4 (CBC)",
