...
namespace DatahubTest
{
    ...
    public class EmailNotificationTest: IClassFixture<EmailNotificationTestFixture>
    {
        ...
        public async void TestAccessRevokedTemplate()
        {
            ...
            var html = await _fixture.EmailNotificationService.RenderTemplate<NRCan.Datahub.Shared.Templates.ServiceAccessRevoked>(parameters);
        ...
        public async void TestAccessRequestTemplate()
        {
            ...
            var html = await _fixture.EmailNotificationService.RenderTemplate<NRCan.Datahub.Shared.Templates.ServiceAccessRequest>(parameters);
        ...
        public async void TestAccessRequestApprovedTemplate()
        {
            ...
            var html = await _fixture.EmailNotificationService.RenderTemplate<NRCan.Datahub.Shared.Templates.ServiceAccessRequestApproved>(parameters);
        ...
        public async void TestServiceCreationRequestApprovedTemplate()
        {
            ...
            var html = await _fixture.EmailNotificationService.RenderTemplate<NRCan.Datahub.Shared.Templates.ServiceRequestApproved>(parameters);
        ...
        public async void TestServiceCreationRequestTemplate()
        {
            ...
            var html = await _fixture.EmailNotificationService.RenderTemplate<NRCan.Datahub.Shared.Templates.ServiceCreationRequest>(parameters);
