    ...
    public class DbTests
    {
        ...
        public async void GivenCosmosCxnStr_ValidateConnection()
        {
            ...
            using (var scope = _serviceProvider.CreateScope())
            {
                ...
                var userRecentActions1 = new UserRecentActions() { UserRecentActionId = Guid.NewGuid(), url = "url1", title = "my title", accessedTime = DateTimeOffset.Now, icon = "myicon" };
                var userRecentActions2 = new UserRecentActions() { UserRecentActionId = Guid.NewGuid(), url = "url2", title = "my title", accessedTime = DateTimeOffset.Now, icon = "myicon" };
                var userRecentActions3 = new UserRecentActions() { UserRecentActionId = Guid.NewGuid(), url = "url3", title = "my title", accessedTime = DateTimeOffset.Now, icon = "myicon" };
                var userRecentActions4 = new UserRecentActions() { UserRecentActionId = Guid.NewGuid(), url = "url4", title = "my title", accessedTime = DateTimeOffset.Now, icon = "myicon" };
                var userRecentActions5 = new UserRecentActions() { UserRecentActionId = Guid.NewGuid(), url = "url5", title = "my title", accessedTime = DateTimeOffset.Now, icon = "myicon" };
