...
if ($Action -eq "AddMigration") {
    ...
    Start-Process -FilePath "dotnet" -ArgumentList "ef migrations add $MigrationName --context SqlServerMetadataDbContext --configuration MIGRATION -v" -NoNewWindow -PassThru -Wait
    Start-Process -FilePath "dotnet" -ArgumentList "ef migrations add $MigrationName --context SqliteMetadataDbContext --configuration MIGRATION -v" -NoNewWindow -PassThru -Wait
...
elseif ($Action -eq "Script") {
    ...
    Start-Process -FilePath "dotnet" -ArgumentList "ef migrations script --context SqlServerMetadataDbContext --configuration MIGRATION -v" -NoNewWindow -PassThru -Wait
...
elseif ($Action -eq "RemoveMigration") {
    ...
    Start-Process -FilePath "dotnet" -ArgumentList "ef migrations remove --context SqlServerMetadataDbContext --configuration MIGRATION -v --force" -NoNewWindow -PassThru -Wait
    Start-Process -FilePath "dotnet" -ArgumentList "ef migrations remove --context SqliteMetadataDbContext --configuration MIGRATION -v --force" -NoNewWindow -PassThru -Wait
