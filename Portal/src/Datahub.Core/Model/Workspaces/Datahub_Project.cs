...
public class Datahub_Project : IComparable<Datahub_Project>
{
    ...
    /// </summary>
    public long? MaxUploadMBForGccf { get; set; }

    /// <summary>
    /// Gets or sets the maximum number of files allowed for GCCF users.
    /// </summary>
    public int? MaxFileCountForGccf { get; set; }

    /// <summary>
    /// Gets a value indicating whether the settings for external users are configured.
    /// </summary>
    [NotMapped]
    public bool ExternalSettingsConfigured => MaxUploadMBForGccf.HasValue && MaxFileCountForGccf.HasValue;
