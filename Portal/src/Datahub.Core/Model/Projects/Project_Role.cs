...
public class ProjectRole
{
    ...
    public static IEnumerable<ProjectRole> GetAll() => roles.Value;

    private static Lazy<IEnumerable<ProjectRole>> roles = new(CreateRoles);

    private static IEnumerable<ProjectRole> CreateRoles()
    {
