        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ConcatenatedRules = table.Column<string>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Id = table.Column<int>(type: "INTEGER", nullable: false),
                    Name_English = table.Column<string>(type: "TEXT", maxLength: 160, nullable: true),
                    Name_French = table.Column<string>(type: "TEXT", maxLength: 160, nullable: true),
                    Desc_English = table.Column<string>(type: "TEXT", nullable: true),
                    Desc_French = table.Column<string>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HealthCheckTimeUtc = table.Column<DateTime>(type: "TEXT", nullable: false, defaultValueSql: "GETUTCDATE()"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    GeneratedId = table.Column<Guid>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FirstLoginDateTime = table.Column<DateTime>(type: "TEXT", nullable: true),
                    LastLoginDateTime = table.Column<DateTime>(type: "TEXT", nullable: true),
                    BannerPictureUrl = table.Column<string>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ProjectApiUser_ID = table.Column<Guid>(type: "TEXT", nullable: false),
                    Client_Name_TXT = table.Column<string>(type: "TEXT", maxLength: 32, nullable: false),
                    Project_Acronym_CD = table.Column<string>(type: "TEXT", maxLength: 10, nullable: false),
                    Email_Contact_TXT = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
                    Expiration_DT = table.Column<DateTime>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ProjectCosts_ID = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    Project_ID = table.Column<int>(type: "INTEGER", nullable: false),
                    Date = table.Column<DateTime>(type: "TEXT", nullable: false),
                    CadCost = table.Column<double>(type: "REAL", nullable: false),
                    ServiceName = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                    CloudProvider = table.Column<string>(type: "TEXT", maxLength: 5, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AverageCapacity = table.Column<double>(type: "REAL", nullable: false),
                    Date = table.Column<DateTime>(type: "TEXT", nullable: false),
                    CloudProvider = table.Column<string>(type: "TEXT", maxLength: 16, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SharedDataFile_ID = table.Column<long>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    File_ID = table.Column<Guid>(type: "TEXT", nullable: false),
                    IsOpenDataRequest_FLAG = table.Column<bool>(type: "INTEGER", nullable: false),
                    Filename_TXT = table.Column<string>(type: "TEXT", nullable: true),
                    FolderPath_TXT = table.Column<string>(type: "TEXT", nullable: true),
                    ProjectCode_CD = table.Column<string>(type: "TEXT", nullable: true),
                    RequestingUser_ID = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
                    ApprovingUser_ID = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
                    RequestedDate_DT = table.Column<DateTime>(type: "TEXT", nullable: false),
                    SubmittedDate_DT = table.Column<DateTime>(type: "TEXT", nullable: true),
                    ApprovedDate_DT = table.Column<DateTime>(type: "TEXT", nullable: true),
                    PublicationDate_DT = table.Column<DateTime>(type: "TEXT", nullable: true),
                    ExpirationDate_DT = table.Column<DateTime>(type: "TEXT", nullable: true),
                    UnpublishDate_DT = table.Column<DateTime>(type: "TEXT", nullable: true),
                    MetadataCompleted_FLAG = table.Column<bool>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Notification_ID = table.Column<long>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    ReceivingUser_ID = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
                    Generated_TS = table.Column<DateTime>(type: "TEXT", nullable: false),
                    Read_FLAG = table.Column<bool>(type: "INTEGER", nullable: false),
                    NotificationTextEn_TXT = table.Column<string>(type: "TEXT", nullable: false),
                    NotificationTextFr_TXT = table.Column<string>(type: "TEXT", nullable: false),
                    ActionLink_URL = table.Column<string>(type: "TEXT", maxLength: 512, nullable: true),
                    ActionLink_Key = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Sector_Name = table.Column<string>(type: "TEXT", maxLength: 4000, nullable: true),
                    Branch_Name = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
                    Division_Name = table.Column<string>(type: "TEXT", nullable: true),
                    Contact_List = table.Column<string>(type: "TEXT", nullable: true),
                    Project_Name = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    Project_Name_Fr = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    Project_Acronym_CD = table.Column<string>(type: "TEXT", maxLength: 10, nullable: false),
                    Project_Budget = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    Project_Admin = table.Column<string>(type: "TEXT", nullable: true),
                    Project_Summary_Desc = table.Column<string>(type: "TEXT", nullable: true),
                    Project_Summary_Desc_Fr = table.Column<string>(type: "TEXT", nullable: true),
                    Project_Goal = table.Column<string>(type: "TEXT", nullable: true),
                    Project_Category = table.Column<string>(type: "TEXT", nullable: true),
                    Initial_Meeting_DT = table.Column<DateTime>(type: "TEXT", nullable: false),
                    Number_Of_Users_Involved = table.Column<int>(type: "INTEGER", nullable: true),
                    Is_Private = table.Column<bool>(type: "INTEGER", nullable: false),
                    Is_Featured = table.Column<bool>(type: "INTEGER", nullable: false),
                    Data_Sensitivity = table.Column<string>(type: "TEXT", nullable: false),
                    Stage_Desc = table.Column<string>(type: "TEXT", nullable: true),
                    Project_Status_Desc = table.Column<string>(type: "TEXT", nullable: true),
                    Project_Status = table.Column<int>(type: "INTEGER", nullable: true),
                    Project_Phase = table.Column<string>(type: "TEXT", nullable: true),
                    GC_Docs_URL = table.Column<string>(type: "TEXT", nullable: true),
                    Project_Icon = table.Column<string>(type: "TEXT", nullable: true),
                    Comments_NT = table.Column<string>(type: "TEXT", nullable: true),
                    Last_Contact_DT = table.Column<DateTime>(type: "TEXT", nullable: true),
                    Next_Meeting_DT = table.Column<DateTime>(type: "TEXT", nullable: true),
                    Last_Updated_DT = table.Column<DateTime>(type: "TEXT", nullable: false),
                    Last_Updated_UserId = table.Column<string>(type: "TEXT", nullable: true),
                    Deleted_DT = table.Column<DateTime>(type: "TEXT", nullable: true),
                    DatahubAzureSubscriptionId = table.Column<int>(type: "INTEGER", nullable: false),
                    Databricks_URL = table.Column<string>(type: "TEXT", maxLength: 400, nullable: true),
                    PowerBI_URL = table.Column<string>(type: "TEXT", maxLength: 400, nullable: true),
                    WebForms_URL = table.Column<string>(type: "TEXT", maxLength: 400, nullable: true),
                    Timestamp = table.Column<byte[]>(type: "BLOB", rowVersion: true, nullable: true),
                    DB_Name = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
                    DB_Server = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
                    DB_Type = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    OnboardingApplicationId = table.Column<int>(type: "INTEGER", nullable: false),
                    MetadataAdded = table.Column<bool>(type: "INTEGER", nullable: true),
                    WebAppEnabled = table.Column<bool>(type: "INTEGER", nullable: true),
                    WebAppUrlRewritingEnabled = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: true),
                    OperationalWindow = table.Column<DateTime>(type: "TEXT", nullable: true),
                    HasCostRecovery = table.Column<bool>(type: "INTEGER", nullable: false),
                    WebApp_URL = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
                    Version = table.Column<string>(type: "TEXT", maxLength: 16, nullable: true),
                    GitRepo_URL = table.Column<string>(type: "TEXT", maxLength: 150, nullable: true),
                    HashedAPIToken = table.Column<string>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    PreviewEn = table.Column<string>(type: "TEXT", nullable: false),
                    PreviewFr = table.Column<string>(type: "TEXT", nullable: false),
                    BodyEn = table.Column<string>(type: "TEXT", nullable: false),
                    BodyFr = table.Column<string>(type: "TEXT", nullable: false),
                    ForceHidden = table.Column<bool>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    PortalUserId = table.Column<int>(type: "INTEGER", nullable: false),
                    AchievementId = table.Column<string>(type: "TEXT", maxLength: 8, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DaysBeforeLocked = table.Column<int>(type: "INTEGER", nullable: false),
                    DaysBeforeDeleted = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PowerBIURL = table.Column<string>(type: "TEXT", nullable: true),
                    Name = table.Column<string>(type: "TEXT", nullable: true),
                    Variant = table.Column<string>(type: "TEXT", nullable: true),
                    DatabricksURL = table.Column<string>(type: "TEXT", nullable: true),
                    AzureWebAppUrl = table.Column<string>(type: "TEXT", nullable: true),
                    WebFormsURL = table.Column<string>(type: "TEXT", nullable: true),
                    DataProject = table.Column<string>(type: "TEXT", nullable: true),
                    PBIReportId = table.Column<string>(type: "TEXT", nullable: true),
                    PBIWorkspaceId = table.Column<string>(type: "TEXT", nullable: true),
                    AccessedTime = table.Column<long>(type: "INTEGER", nullable: false),
                    ExternalUrl = table.Column<string>(type: "TEXT", nullable: true),
                    ResourceArticleId = table.Column<string>(type: "TEXT", nullable: true),
                    ResourceArticleTitle = table.Column<string>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HideAchievements = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: false),
                    HideAlerts = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: false),
                    HiddenAlerts = table.Column<string>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SharedDataFile_ID = table.Column<long>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    ApprovalForm_ID = table.Column<int>(type: "INTEGER", nullable: true),
                    SignedApprovalForm_URL = table.Column<string>(type: "TEXT", nullable: true),
                    ApprovalFormRead_FLAG = table.Column<bool>(type: "INTEGER", nullable: false),
                    FileStorage_CD = table.Column<int>(type: "INTEGER", nullable: true),
                    UploadStatus_CD = table.Column<int>(type: "INTEGER", nullable: false),
                    UploadError_TXT = table.Column<string>(type: "TEXT", nullable: true),
                    FileUrl_TXT = table.Column<string>(type: "TEXT", nullable: true),
                    ApprovalFormEdited_FLAG = table.Column<bool>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DatasetTitle = table.Column<string>(type: "TEXT", nullable: true),
                    Status = table.Column<string>(type: "TEXT", nullable: true),
                    OpenForAttachingFiles = table.Column<bool>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    ProjectId = table.Column<int>(type: "INTEGER", nullable: false),
                    Provider = table.Column<string>(type: "TEXT", maxLength: 16, nullable: false, defaultValue: "Azure"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastRollover = table.Column<DateTime>(type: "TEXT", nullable: true),
                    Current = table.Column<double>(type: "REAL", nullable: false),
                    BudgetCurrentSpent = table.Column<double>(type: "REAL", nullable: false),
                    CurrentPerService = table.Column<string>(type: "TEXT", nullable: true),
                    CurrentPerDay = table.Column<string>(type: "TEXT", nullable: true),
                    YesterdayCredits = table.Column<double>(type: "REAL", nullable: false),
                    YesterdayPerService = table.Column<string>(type: "TEXT", nullable: true),
                    LastNotified = table.Column<DateTime>(type: "TEXT", nullable: true),
                    PercNotified = table.Column<int>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    ProjectId = table.Column<int>(type: "INTEGER", nullable: false),
                    RepositoryUrl = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
                    Path = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
                    Provider = table.Column<string>(type: "TEXT", maxLength: 32, nullable: false),
                    Branch = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
                    HeadCommitId = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    UpdatedById = table.Column<int>(type: "INTEGER", nullable: true),
                    InputJsonContent = table.Column<string>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ProjectUser_ID = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    PortalUserId = table.Column<int>(type: "INTEGER", nullable: true),
                    ApprovedPortalUserId = table.Column<int>(type: "INTEGER", nullable: true),
                    ...
                    IsDataApprover = table.Column<bool>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    ProjectId = table.Column<int>(type: "INTEGER", nullable: false),
                    AdminLastUpdated_ID = table.Column<string>(type: "TEXT", nullable: true),
                    AdminLastUpdated_UserName = table.Column<string>(type: "TEXT", nullable: true),
                    LastUpdated = table.Column<DateTime>(type: "TEXT", nullable: false),
                    AllowStorage = table.Column<bool>(type: "INTEGER", nullable: false),
                    AllowDatabricks = table.Column<bool>(type: "INTEGER", nullable: false),
                    AllowVMs = table.Column<bool>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    ProjectId = table.Column<int>(type: "INTEGER", nullable: false),
                    InterestedFeatures = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
                    CreatedById = table.Column<int>(type: "INTEGER", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Project_ID = table.Column<int>(type: "INTEGER", nullable: false),
                    NotificationDate = table.Column<DateTime>(type: "TEXT", nullable: false),
                    DaysBeforeDeletion = table.Column<int>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    MetadataComplete = table.Column<bool>(type: "INTEGER", nullable: false),
                    OpenGovCriteriaFormId = table.Column<int>(type: "INTEGER", nullable: true),
                    OpenGovCriteriaMetDate = table.Column<DateTime>(type: "TEXT", nullable: true),
                    LocalDQCheckStarted = table.Column<bool>(type: "INTEGER", nullable: false),
                    LocalDQCheckPassed = table.Column<bool>(type: "INTEGER", nullable: false),
                    InitialOpenGovSubmissionDate = table.Column<DateTime>(type: "TEXT", nullable: true),
                    OpenGovDQCheckPassed = table.Column<bool>(type: "INTEGER", nullable: false),
                    ImsoApprovalRequestDate = table.Column<DateTime>(type: "TEXT", nullable: true),
                    ImsoApprovedDate = table.Column<DateTime>(type: "TEXT", nullable: true),
                    OpenGovPublicationDate = table.Column<DateTime>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FilePurpose = table.Column<string>(type: "TEXT", nullable: true),
                    ProjectStorageId = table.Column<int>(type: "INTEGER", nullable: true),
                    ...
                    UploadMessage = table.Column<string>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
