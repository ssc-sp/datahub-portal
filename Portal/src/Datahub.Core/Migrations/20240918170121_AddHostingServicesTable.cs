    ...
    public partial class AddHostingServicesTable : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Revoke the user's access to the workspace", "Remove User" },
                    { 2, "Head of the workspace and bears business responsibility for success of the workspace", "Workspace Lead" },
                    { 3, "Management authority within the workspace with direct supervision over the cloud resourcing and users", "Admin" },
                    { 4, "Responsible for contributing to the overall workspace objectives and deliverables", "Collaborator" },
