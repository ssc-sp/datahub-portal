...
namespace Datahub.Core.Migrations.Core
{
    ...
    [Migration("20230424131019_AddingAchievementsDBContext")]
    partial class AddingAchievementsDBContext
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Datahub.Core.Model.Achievements.Achievement", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "DHA-001",
                            ConcatenatedRules = "Utils.EventMetricExactCount(\"user_login\", EventMetrics) > 0",
                        ...
                        {
                            Id = "DHA-002",
                            ConcatenatedRules = "Utils.EventMetricExactCount(\"user_sent_invite\", EventMetrics) > 0",
                        ...
                        {
                            Id = "DHA-003",
                            ConcatenatedRules = "Utils.EventMetricExactCount(\"user_joined_project\", EventMetrics) > 0",
                        ...
                        {
                            Id = "DHA-004",
                            ConcatenatedRules = "Utils.EventMetricExactCount(\"user_left_project\", EventMetrics) > 0",
                        ...
                        {
                            Id = "DHA-005",
                            ConcatenatedRules = "Utils.EventMetricExactCount(\"user_daily_login\", EventMetrics) > 0",
                        ...
                        {
                            Id = "STR-001",
                            ConcatenatedRules = "Utils.EventMetricExactCount(\"user_upload_file\", EventMetrics) > 0",
                        ...
                        {
                            Id = "STR-002",
                            ConcatenatedRules = "Utils.EventMetricExactCount(\"user_share_file\", EventMetrics) > 0",
                        ...
                        {
                            Id = "STR-004",
                            ConcatenatedRules = "Utils.EventMetricExactCount(\"user_delete_file\", EventMetrics) > 0",
                        ...
                        {
                            Id = "STR-005",
                            ConcatenatedRules = "Utils.EventMetricExactCount(\"user_create_folder\", EventMetrics) > 0",
                        ...
                        {
                            Id = "STR-006",
                            ConcatenatedRules = "Utils.EventMetricExactCount(\"user_delete_folder\", EventMetrics) > 0",
                        ...
                        {
                            Id = "EXP-001",
                            ConcatenatedRules = "Utils.EventMetricExactCount(\"user_view_file_explorer\", EventMetrics) > 0",
                        ...
                        {
                            Id = "EXP-002",
                            ConcatenatedRules = "Utils.EventMetricExactCount(\"user_click_databricks_link\", EventMetrics) > 0",
                        ...
                        {
                            Id = "EXP-003",
                            ConcatenatedRules = "Utils.EventMetricExactCount(\"user_visit_resources\", EventMetrics) > 0",
                        ...
                        {
                            Id = "EXP-004",
                            ConcatenatedRules = "Utils.EventMetricExactCount(\"user_view_project_not_member_of\", EventMetrics) > 0",
                        ...
                        {
                            Id = "EXP-005",
                            ConcatenatedRules = "Utils.EventMetricExactCount(\"user_view_project\", EventMetrics) > 0",
                        ...
                        {
                            Id = "EXP-006",
                            ConcatenatedRules = "Utils.EventMetricExactCount(\"user_click_recent_link\", EventMetrics) > 0",
                        ...
                        {
                            Id = "EXP-007",
                            ConcatenatedRules = "Utils.EventMetricExactCount(\"user_click_toggle_culture\", EventMetrics) > 0",
                        ...
                        {
                            Id = "EXP-008",
                            ConcatenatedRules = "Utils.EventMetricExactCount(\"user_view_profile\", EventMetrics) > 0",
                        ...
                        {
                            Id = "EXP-009",
                            ConcatenatedRules = "Utils.EventMetricExactCount(\"user_view_other_profile\", EventMetrics) > 0",
