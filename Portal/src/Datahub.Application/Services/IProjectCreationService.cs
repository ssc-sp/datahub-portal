...
public interface IProjectCreationService
{
    ...
    public Task CreateProjectCloudHostingEndPointAsync(string projectName, string acronym, string organization, PortalUser portalUser);
    ...
    public Task SaveProjectCreationDetailsAsync(string projectAcronym, string? interestedFeatures = null);
