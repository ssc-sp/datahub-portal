...
#line hidden
        ...
        public static async System.Threading.Tasks.Task FeatureSetupAsync()
        {
            ...
            Reqnroll.FeatureInfo featureInfo = new Reqnroll.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features", "WorkspaceBudget", "\tTests for the workspace budget management service", ProgrammingLanguage.CSharp, featureTags);
        ...
        public async System.Threading.Tasks.Task QueryingBudgetAmountForAWorkspaceShouldReturnTheRightAmount()
        {
            ...
            Reqnroll.ScenarioInfo scenarioInfo = new Reqnroll.ScenarioInfo("Querying budget amount for a workspace should return the right amount", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 5
...
#line 6
 await testRunner.GivenAsync("a workspace with a budget identifier of \"/subscriptions/bc4bcb08-d617-49f4-b6af-6" +
                        ...
                        "udgets/fsdh-test-budget\"", ((string)(null)), ((Reqnroll.Table)(null)), "Given ");
#line hidden
#line 7
 await testRunner.AndAsync("the budget amount is $1000", ((string)(null)), ((Reqnroll.Table)(null)), "And ");
#line hidden
#line 8
 await testRunner.WhenAsync("the budget amount is queried for the workspace", ((string)(null)), ((Reqnroll.Table)(null)), "When ");
#line hidden
#line 9
 await testRunner.ThenAsync("the result should be the expected amount", ((string)(null)), ((Reqnroll.Table)(null)), "Then ");
#line hidden
            }
        ...
        public async System.Threading.Tasks.Task SettingABudgetAmountForAWorkspaceShouldUpdateTheBudgetAmount()
        {
            string[] tagsOfScenario = ((string[])(null));
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            Reqnroll.ScenarioInfo scenarioInfo = new Reqnroll.ScenarioInfo("Setting a budget amount for a workspace should update the budget amount", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 11
this.ScenarioInitialize(scenarioInfo);
#line hidden
            if ((TagHelper.ContainsIgnoreTag(tagsOfScenario) || TagHelper.ContainsIgnoreTag(featureTags)))
...
#line hidden
#line 14
 await testRunner.WhenAsync("the budget amount is set to $500 for the workspace", ((string)(null)), ((Reqnroll.Table)(null)), "When ");
#line hidden
#line 15
 await testRunner.ThenAsync("the result should be the expected amount", ((string)(null)), ((Reqnroll.Table)(null)), "Then ");
#line hidden
        ...
        public async System.Threading.Tasks.Task QueryingBudgetSpentForAWorkspaceShouldReturnTheRightAmount()
        {
            string[] tagsOfScenario = ((string[])(null));
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            Reqnroll.ScenarioInfo scenarioInfo = new Reqnroll.ScenarioInfo("Querying budget spent for a workspace should return the right amount", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 17
this.ScenarioInitialize(scenarioInfo);
#line hidden
            if ((TagHelper.ContainsIgnoreTag(tagsOfScenario) || TagHelper.ContainsIgnoreTag(featureTags)))
...
#line hidden
#line 19
 await testRunner.AndAsync("the budget spent is less than $10", ((string)(null)), ((Reqnroll.Table)(null)), "And ");
#line hidden
#line 20
 await testRunner.WhenAsync("the budget spent is queried for the workspace", ((string)(null)), ((Reqnroll.Table)(null)), "When ");
#line hidden
#line 21
 await testRunner.ThenAsync("the result should be less than the expected amount", ((string)(null)), ((Reqnroll.Table)(null)), "Then ");
#line hidden
            }
            await this.ScenarioCleanupAsync();
        }
        ...
        public async System.Threading.Tasks.Task UpdatingBudgetSpentForAWorkspaceShouldUpdateTheBudgetSpent()
        {
            string[] tagsOfScenario = ((string[])(null));
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            Reqnroll.ScenarioInfo scenarioInfo = new Reqnroll.ScenarioInfo("Updating budget spent for a workspace should update the budget spent", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 23
this.ScenarioInitialize(scenarioInfo);
#line hidden
            if ((TagHelper.ContainsIgnoreTag(tagsOfScenario) || TagHelper.ContainsIgnoreTag(featureTags)))
...
#line hidden
#line 25
 await testRunner.AndAsync("an existing project credit record", ((string)(null)), ((Reqnroll.Table)(null)), "And ");
#line hidden
#line 26
 await testRunner.WhenAsync("the budget is updated for that workspace", ((string)(null)), ((Reqnroll.Table)(null)), "When ");
#line hidden
#line 27
 await testRunner.ThenAsync("project credit record should be updated", ((string)(null)), ((Reqnroll.Table)(null)), "Then ");
#line hidden
            }
            await this.ScenarioCleanupAsync();
        }
