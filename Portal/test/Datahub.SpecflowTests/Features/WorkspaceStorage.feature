...
Scenario: Getting the storage capacity should return the correct value
	...
	And the storage account has a capacity of above 0 bytes and below 6000000 bytes
...
Scenario: Updating the storage capacity should return the correct value
	...
	And the storage account has a capacity of above 5000000 bytes and below 6000000 bytes
