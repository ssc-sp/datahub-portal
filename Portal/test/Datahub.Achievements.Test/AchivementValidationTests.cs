...
public class AchievementValidationTests
{
    ...
    {
        ("EXP-001", TelemetryEvents.UserLogin, 1, 0),
        ("EXP-002", STORAGE_EXPLORER_URL, 1, 0),
        ("EXP-003", TelemetryEvents.UserOpenDatabricks, 1, 0),
        ("EXP-004", RESOURCES_URL, 1, 0),
        ("EXP-005", TelemetryEvents.UserViewProjectNotMemberOf, 1, 0),
        ("EXP-006", PROFILE_URL, 1, 0),
        ("EXP-007", TelemetryEvents.UserRecentLink, 1, 0),
        ("EXP-008", TelemetryEvents.UserToggleCulture, 1, 0),
        // ("EXP-009", ALL_EXPLORATION_PREFIX, 1, 0),
        ("EXP-010", PROJECT_URL, 1, 0),
        ("EXP-011", TelemetryEvents.UserViewOtherProfile, 1, 0),
        
        // include the events for unlocking all of the 01 exploration
        ("EXP-009", "garbage", 1, 0),
        ("EXP-009", TelemetryEvents.UserLogin, 1, 0),
        ("EXP-009", STORAGE_EXPLORER_URL, 1, 0),
        ("EXP-009", TelemetryEvents.UserOpenDatabricks, 1, 0),
        ("EXP-009", RESOURCES_URL, 1, 0),
        ("EXP-009", TelemetryEvents.UserViewProjectNotMemberOf, 1, 0),
        ("EXP-009", PROFILE_URL, 1, 0),
        ("EXP-009", TelemetryEvents.UserRecentLink, 1, 0),
        ("EXP-009", TelemetryEvents.UserToggleCulture, 1, 0),
        ("EXP-009", PROJECT_URL, 1, 0),
        ("EXP-009", TelemetryEvents.UserViewOtherProfile, 1, 0),

        ("PRJ-001", TelemetryEvents.UserSentInvite, 1, 0),
        ("PRJ-002", TelemetryEvents.UserJoinedProject, 1, 0),
        ("PRJ-003", TelemetryEvents.UserUploadFile, 1, 0),
        ("PRJ-004", TelemetryEvents.UserShareFile, 1, 0),
        ("PRJ-005", TelemetryEvents.UserDownloadFile, 1, 0),
        ("PRJ-006", TelemetryEvents.UserDeleteFile, 1, 0),
        ("PRJ-007", TelemetryEvents.UserCreateFolder, 1, 0),
        
        // include the events for unlocking all of the 01 project
        ("PRJ-008", "garbage", 1, 0),
        ("PRJ-008", TelemetryEvents.UserSentInvite, 1, 0),
        ("PRJ-008", TelemetryEvents.UserJoinedProject, 1, 0),
        ("PRJ-008", TelemetryEvents.UserUploadFile, 1, 0),
        ("PRJ-008", TelemetryEvents.UserShareFile, 1, 0),
        ("PRJ-008", TelemetryEvents.UserDownloadFile, 1, 0),
        ("PRJ-008", TelemetryEvents.UserDeleteFile, 1, 0),
        ("PRJ-008", TelemetryEvents.UserCreateFolder, 1, 0),
    };
